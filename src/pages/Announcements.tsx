...
import { announcementFocalPosition, announcementImageSrc, formatAnnouncementDate, isSafeExternalUrl } from "@/lib/announcements";
    ...
    <div className="relative z-10 mx-auto max-w-3xl space-y-6">
      ...
      <div className="space-y-4">
        {items.map((item, index) => {
          const imageSrc = announcementImageSrc(item, announcementPublicUrl);
          return (
            <Card key={item.id} className="overflow-hidden bg-card/95">
              {imageSrc ? (
                <MediaFrame>
                  <img
                    src={imageSrc}
                    ...
                    style={{ objectPosition: announcementFocalPosition(item) }}
