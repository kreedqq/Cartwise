...
- [ ] User-approved git backup of the dirty `main` working tree (do not commit unless asked)
...
- [ ] Populate remaining identity substances (Semax, Selank, TA-1, KPV, IGF-1 LR3, Somatropin, HCG, Gonadorelin, Melanotan II) **only** with verified sources
